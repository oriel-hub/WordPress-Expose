...
$exposed_standard_fields = idsapi_variable_get('okhub_expose', 'standard_fields_'.$taxonomy, $default_taxonomy_fields);
$exposed_custom_fields = idsapi_variable_get('okhub_expose', 'custom_fields_'.$taxonomy, array());
