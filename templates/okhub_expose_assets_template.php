...
$exposed_custom_fields = idsapi_variable_get('okhub_expose', 'custom_fields_'.$post_type, array());
$exposed_standard_fields = idsapi_variable_get('okhub_expose', 'standard_fields_'.$post_type, $default_standard_fields);
...
<?php while ($loop->have_posts()) : $loop->the_post(); ?>
    ...
    <?php
      ...
      foreach($taxonomies as $tax_name) { 
        $exposed_standard_taxonomy_fields = idsapi_variable_get('okhub_expose', 'standard_fields_'.$tax_name, $default_taxonomy_fields);
        $exposed_custom_taxonomy_fields = idsapi_variable_get('okhub_expose', 'custom_fields_'.$tax_name, array());
